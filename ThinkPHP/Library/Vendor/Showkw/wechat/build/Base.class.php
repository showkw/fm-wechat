...
class Base extends Error
{
    ...
    {
        $cache = C('api.wechat.cache_path');
        $this->appid     = C('api.wechat.appid');
        $this->appsecret = C('api.wechat.appsecret');
        $this->cacheDir  = empty($cache)?C('DATA_CACHE_PATH'):$cache;
//        $this->setAccessToken();
//        $this->setMessage();
    }
    ...
    {
        $class = '\Showkw\wechat\build\\'.ucfirst($api);
